...
function PitchMarkings({ pitchCanvasHeight, pixelsPerXUnit, pixelsPerYUnit, statsbombPitchWidth }) {
    ...
    return (
        <>
            <Line points={[scaleX(60), 0, scaleX(60), pitchCanvasHeight]} stroke={lineColor} strokeWidth={lineWidth} listening={false} />
            <Circle x={scaleX(60)} y={scaleY(40)} radius={10 * pixelsPerXUnit} stroke={lineColor} strokeWidth={lineWidth} listening={false} />
            ...
            <Rect x={scaleX(statsbombPitchWidth)} y={scaleY(36)} width={scaleX(2)} height={scaleY(44) - scaleY(36)} stroke={lineColor} strokeWidth={lineWidth} fill="transparent" listening={false} />
        </>
    )
}
    ...
    return (
        <div className="overflow-hidden rounded-xl shadow-2xl ring-1 ring-white/10">
            <Stage width={pitchCanvasWidth} height={pitchCanvasHeight}>
                <Layer>
                    <Rect x={0} y={0} width={pitchCanvasWidth} height={pitchCanvasHeight} fill="#2d6a4f" />
